...
<div style={{ position: 'relative', paddingTop: '56.25%', marginTop: '2rem', marginBottom: '2rem', borderRadius: '12px', overflow: 'hidden' }}><iframe src="https://iframe.mediadelivery.net/embed/165/41a40b87-5036-4c41-9b19-545d055deb56?autoplay=true&loop=true&muted=true&preload=true&responsive=true" loading="lazy" style={{ border:0, position: 'absolute', top: 0, height: '100%', width: '100%'}} allow="accelerometer;gyroscope;autoplay;encrypted-media;picture-in-picture;" allowFullScreen></iframe></div>
...
<div style={{position: 'relative', height: '0', paddingTop: '56%', overflow: 'hidden', maxWidth: '100%', marginTop: '2rem', marginBottom: '2rem', borderRadius: '12px', overflow: 'hidden' }}>
  <iframe style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }} src="https://www.youtube.com/embed/xLVJP-o0g28" frameBorder="0" allowFullScreen></iframe>
</div>
...
[Demo Mastodon Post](https://mastodon.gamedev.place/@orels1/110212561455021460?ref=blog.orels.sh)

<div style={{ position: 'relative', paddingTop: '56.25%', marginTop: '2rem', marginBottom: '2rem', borderRadius: '12px', overflow: 'hidden' }}><iframe src="https://iframe.mediadelivery.net/embed/165/b1faa103-2c97-4849-b7ba-e9dc6e5862ab?autoplay=true&loop=true&muted=true&preload=true&responsive=true" loading="lazy" style={{ border:0, position: 'absolute', top: 0, height: '100%', width: '100%'}} allow="accelerometer;gyroscope;autoplay;encrypted-media;picture-in-picture;" allowFullScreen></iframe></div>
...
<div style={{ position: 'relative', paddingTop: '56.25%', marginTop: '2rem', marginBottom: '2rem', borderRadius: '12px', overflow: 'hidden' }}><iframe src="https://iframe.mediadelivery.net/embed/165/e6727ff7-5aca-4f77-bdf1-6e52d9104edd?autoplay=true&loop=true&muted=true&preload=true&responsive=true" loading="lazy" style={{ border:0, position: 'absolute', top: 0, height: '100%', width: '100%'}} allow="accelerometer;gyroscope;autoplay;encrypted-media;picture-in-picture;" allowFullScreen></iframe></div>
...
<div style={{ position: 'relative', paddingTop: '140.25%', marginTop: '2rem', marginBottom: '2rem', borderRadius: '12px', overflow: 'hidden' }}><iframe src="https://iframe.mediadelivery.net/embed/165/f6833cda-0904-43ee-9cb6-6e8360f11da4?autoplay=true&loop=true&muted=true&preload=true&responsive=true" loading="lazy" style={{ border:0, position: 'absolute', top: 0, height: '100%', width: '100%'}} allow="accelerometer;gyroscope;autoplay;encrypted-media;picture-in-picture;" allowFullScreen></iframe></div>
...
![Summer Tower](/img/posts/2023-year-in-review/2023-year-in-review-image.png "Summer Tower")
...
<div style={{ position: 'relative', paddingTop: '48.25%', marginTop: '2rem', marginBottom: '2rem', borderRadius: '12px', overflow: 'hidden' }}><iframe src="https://iframe.mediadelivery.net/embed/165/198c68d6-52e9-4a6b-b01c-5a97c519605a?autoplay=true&loop=true&muted=true&preload=true&responsive=true" loading="lazy" style={{ border:0, position: 'absolute', top: 0, height: '100%', width: '100%'}} allow="accelerometer;gyroscope;autoplay;encrypted-media;picture-in-picture;" allowFullScreen></iframe></div>
...
<div style={{ position: 'relative', paddingTop: '101.25%', marginTop: '2rem', marginBottom: '2rem', borderRadius: '12px', overflow: 'hidden' }}><iframe src="https://iframe.mediadelivery.net/embed/165/393529ba-4f7d-4819-a93a-771893ac87cb?autoplay=true&loop=true&muted=true&preload=true&responsive=true" loading="lazy" style={{ border:0, position: 'absolute', top: 0, height: '100%', width: '100%'}} allow="accelerometer;gyroscope;autoplay;encrypted-media;picture-in-picture;" allowFullScreen></iframe></div>
...
[Other Engines part 1](https://mastodon.gamedev.place/@orels1/111087700939189872?ref=blog.orels.sh)

[Other Engines part 2](https://mastodon.gamedev.place/@orels1/111098952850572003?ref=blog.orels.sh)
...
<div style={{ position: 'relative', paddingTop: '56.25%', marginTop: '2rem', marginBottom: '2rem', borderRadius: '12px', overflow: 'hidden' }}><iframe src="https://iframe.mediadelivery.net/embed/165/b917693e-2028-4346-96cc-bf53d334eefc?autoplay=true&loop=true&muted=true&preload=true&responsive=true" loading="lazy" style={{ border:0, position: 'absolute', top: 0, height: '100%', width: '100%'}} allow="accelerometer;gyroscope;autoplay;encrypted-media;picture-in-picture;" allowFullScreen></iframe></div>

---

I also discovered a nifty little WinUI component library for WPF called WPF UI during that time.

[WPF UI](https://wpfui.lepo.co/?ref=blog.orels.sh)
...
<div style={{ position: 'relative', paddingTop: '56.25%', marginTop: '2rem', marginBottom: '2rem', borderRadius: '12px', overflow: 'hidden' }}><iframe src="https://iframe.mediadelivery.net/embed/165/45f30ce6-0dcd-4340-854b-f11f13d61e0a?autoplay=true&loop=true&muted=true&preload=true&responsive=true" loading="lazy" style={{ border:0, position: 'absolute', top: 0, height: '100%', width: '100%'}} allow="accelerometer;gyroscope;autoplay;encrypted-media;picture-in-picture;" allowFullScreen></iframe></div>
...
[orels Music System](https://musicsystem.orels.sh/?ref=blog.orels.sh)
...
<div style={{position: 'relative', height: '0', paddingTop: '56%', overflow: 'hidden', maxWidth: '100%', marginTop: '2rem', marginBottom: '2rem', borderRadius: '12px', overflow: 'hidden' }}>
  <iframe style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }} src="https://www.youtube.com/embed/eI5YCip44gQ" frameBorder="0" allowFullScreen></iframe>
</div>
